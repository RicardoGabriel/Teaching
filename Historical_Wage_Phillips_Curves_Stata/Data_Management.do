/*
Data Management - Monetary Policy and the Wage-Inflation Unemployment Trade-off
...
*import data
*use "$hp\Data\JSTdataset_v97.dta", clear
use "$hp\Data\2022\JSTdataset_v100.dta", clear

merge 1:1 iso year using "C:\Users\ricar\sciebo\HWPC\Data\2022\OECD_Expectations.dta"
drop _merge
...
* world GDP growth (close to JST 2020)
sort year
...
* replace wage variable by missing value (one can change this in the master file)
if ($wage_out ==1) {
...
**** 3) Capital Openess
* merge Capital Openess from Quinn et al.(2011) extended in Jorda et al.(2020) and by me until 2020
merge 1:1 iso year using "$hp\Data\openquinn_IRL.dta"
*merge 1:1 iso year using "$hp\Data\openquinn.dta"
drop if _merge==2
drop _merge
